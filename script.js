...
const Hackathon = {
    ...
    NL_DATA_CONTEST: { name: "2026 도서관 데이터 활용 공모전", link: "https://www.nl.go.kr", dots: "🌕", icon: "📚", themeColor: "slate-500", recruitStart: "6월 1일 2026", recruitEnd: "8월 7일 2026", activity: ["6월", "7월", "8월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE, HackathonPrize.CERTIFICATE], description: "국립중앙도서관 주관 도서관 데이터 활용 공모전. 시상규모 100만원, 상장 수여. 지원 이메일: libdata@korea.kr", fields: [Field.DATA_ANALYSIS] },
