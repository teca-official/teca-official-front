...
const Hackathon = {
    ...
    GOORMTHON_SPRING: { name: "9oormthon in JEJU (spring)", link: "https://goormthon.com/", dots: "🌕🌕", icon: "☁️", themeColor: "slate-500", recruitStart: "1월 24일 2025", recruitEnd: "2월 5일 2025", activity: ["1월", "2월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE], description: "카카오 주관 제주도 3박 4일 해커톤. 프론트엔드, 백엔드, 디자인, 기획 분야 참가 가능", fields: [Field.FRONTEND, Field.BACKEND, Field.DESIGN, Field.PM] },
    GOORMTHON_SUMMER: { name: "9oormthon in JEJU (summer)", link: "https://goormthon.com/", dots: "🌕🌕", icon: "☁️", themeColor: "slate-500", recruitStart: "6월 9일 2025", recruitEnd: "6월 22일 2025", activity: ["6월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE], description: "카카오 주관 제주도 3박 4일 해커톤. 프론트엔드, 백엔드, 디자인, 기획 분야 참가 가능", fields: [Field.FRONTEND, Field.BACKEND, Field.DESIGN, Field.PM] },
    GOORMTHON_FALL: { name: "9oormthon in JEJU (fall)", link: "https://goormthon.com/", dots: "🌕🌕", icon: "☁️", themeColor: "slate-500", recruitStart: "8월 26일 2025", recruitEnd: "9월 8일 2025", activity: ["8월", "9월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE], description: "카카오 주관 제주도 3박 4일 해커톤. 프론트엔드, 백엔드, 디자인, 기획 분야 참가 가능", fields: [Field.FRONTEND, Field.BACKEND, Field.DESIGN, Field.PM] },
    GOORMTHON_WINTER: { name: "9oormthon in JEJU (winter)", link: "https://goormthon.com/", dots: "🌕🌕", icon: "☁️", themeColor: "slate-500", recruitStart: "11월 4일 2025", recruitEnd: "11월 17일 2025", activity: ["11월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE], description: "카카오 주관 제주도 3박 4일 해커톤. 프론트엔드, 백엔드, 디자인, 기획 분야 참가 가능", fields: [Field.FRONTEND, Field.BACKEND, Field.DESIGN, Field.PM] },
};
