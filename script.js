...
const Hackathon = {
    ...
    ZERO100_BUILDERTHON: { name: "Zero100 글로벌 바이브코딩 빌더톤 in 서울", link: "", dots: "🌕", icon: "👩‍💻", themeColor: "slate-500", recruitStart: "3월 7일 2026", recruitEnd: "3월 19일 2026", activity: ["3월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "Women in Vibe Coding 주관 오프라인(서울) 바이브코딩 빌더톤", fields: [Field.AI, Field.WEB] },
    DDALKKAKTON: { name: "딸깍톤", link: "", dots: "🌕", icon: "🎉", themeColor: "slate-500", recruitStart: "3월 14일 2026", recruitEnd: "3월 20일 2026", activity: ["3월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE], description: "바이브 코딩 클럽 주관 해커톤. 만우절에 진심인 개발자들의 축제, 숭실대 오프라인 진행", fields: [Field.AI] },
    AGENT_HACKATHON: { name: "비즈니스 리더를 위한 Agent Hackathon", link: "", dots: "🌕", icon: "🤖", themeColor: "slate-500", recruitStart: "3월 19일 2026", recruitEnd: "3월 26일 2026", activity: ["3월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "메가존클라우드 주관 온라인 AI 에이전트 해커톤", fields: [Field.AI] },
    RALPHTHON: { name: "Ralphthon @SF", link: "", dots: "🌕", icon: "🌉", themeColor: "slate-500", recruitStart: "3월 14일 2026", recruitEnd: "3월 29일 2026", activity: ["3월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "Team Attention 주관, OpenAI 후원 샌프란시스코 오프라인 해커톤", fields: [Field.AI] },
    OSSCA_MENTOR: { name: "오픈소스 컨트리뷰션 아카데미 멘토단", link: "", dots: "🌕", icon: "🌐", themeColor: "slate-500", recruitStart: "2월 24일 2026", recruitEnd: "3월 29일 2026", activity: ["3월"], eligibility: [Eligibility.WORKER], prize: [HackathonPrize.CERTIFICATE], description: "과학기술정보통신부 주관 오픈소스 컨트리뷰션 아카데미 멘토단 모집", fields: [Field.BACKEND] },
    OSSCA_MENTEE: { name: "오픈소스 컨트리뷰션 아카데미 [체험형] 멘티", link: "", dots: "🌕", icon: "🌐", themeColor: "slate-500", recruitStart: "3월 10일 2026", recruitEnd: "4월 1일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.CERTIFICATE], description: "과학기술정보통신부 주관 오픈소스 컨트리뷰션 아카데미 체험형 멘티 모집", fields: [Field.BACKEND] },
    VIBE_CODING_CONTEST: { name: "바이브코딩 공모전", link: "", dots: "🌕", icon: "🎵", themeColor: "slate-500", recruitStart: "3월 16일 2026", recruitEnd: "4월 3일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "코리아 IT 아카데미 주관 온라인 바이브코딩 공모전", fields: [Field.AI, Field.WEB] },
    SNOWFLAKE_HACKATHON: { name: "SNOWFLAKE Hackathon 2026", link: "", dots: "🌕", icon: "❄️", themeColor: "slate-500", recruitStart: "3월 17일 2026", recruitEnd: "4월 5일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "Snowflake 주관 오프라인 AI 해커톤", fields: [Field.AI] },
    LABOR_DATA_AI_CONTEST: { name: "제5회 고용노동 공공데이터·AI 활용 공모전", link: "", dots: "🌕", icon: "📊", themeColor: "slate-500", recruitStart: "3월 16일 2026", recruitEnd: "5월 14일 2026", activity: ["3월", "4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "고용노동부 주관 공공데이터·AI 활용 공모전", fields: [Field.AI, Field.DATA_ANALYSIS] },
};
