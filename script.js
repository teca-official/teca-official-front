...
const Club = {
    ...
    // 2026-04-18
    CMC_1: { name: "CMC (1학기)", link: "https://cmc.makeus.in/", dots: "🌕🌕🌗", icon: "🚀", themeColor: "slate-500", recruitStart: "4월 18일 2026", recruitEnd: "4월 24일 2026", activity: ["3월", "4월", "5월", "6월", "7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "MakeUs Challenge의 약자로, 기획, 디자인, 개발 직군이 모여 실제 서비스를 런칭하고 운영하는 동아리", fields: [Field.PM, Field.DESIGN, Field.ANDROID, Field.IOS, Field.WEB, Field.SPRING, Field.REACT_NATIVE] },
    // 2026-05-12
    NEXTERS_SUMMER: { name: "넥스터즈 (여름방학)", link: "https://nexters.co.kr/", dots: "🌕🌕🌕", icon: "🌊", themeColor: "slate-500", recruitStart: "5월 12일 2026", recruitEnd: "5월 19일 2026", activity: ["7월", "8월", "9월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "디자이너와 개발자가 모여 8주 동안 서비스를 만들고 런칭하는 것을 목표로 하는 동아리", fields: [Field.DESIGN, Field.ANDROID, Field.IOS, Field.WEB, Field.BACKEND] },
    // 2026-05-25
    PIROGRAMMING_SUMMER: { name: "피로그래밍 (여름방학)", link: "https://pirogramming.com/", dots: "🌕", icon: "☕", themeColor: "slate-500", recruitStart: "5월 25일 2026", recruitEnd: "6월 5일 2026", activity: ["7월", "8월"], eligibility: [Eligibility.UNIVERSITY], description: "Python 웹 프로그래밍을 함께 공부하고 실제 서비스를 개발하며 성장하는 동아리", fields: [Field.WEB, Field.DJANGO] },
    // 2025-06-09
    TOBIGS_H2: { name: "투빅스 (하반기)", link: "http://www.datamarket.kr/xe/page_QEhq64", dots: "🌕🌕", icon: "📊", themeColor: "slate-500", recruitStart: "6월 9일 2025", recruitEnd: "6월 24일 2025", activity: ["7월", "8월", "9월", "10월", "11월", "12월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "데이터 분석 및 AI 분야에 대한 학술적 깊이를 추구하며 함께 성장하는 데이터 분석 연합 동아리", fields: [Field.ML, Field.DL] },
    // 2026-05-22
    DND_SUMMER: { name: "DnD (여름방학)", link: "https://dnd.ac/", dots: "🌕🌕", icon: "🎲", themeColor: "slate-500", recruitStart: "6월 1일 2026", recruitEnd: "6월 14일 2026", activity: ["7월", "8월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "'프로젝트에 즐거움을, 모두에게 기회를'이라는 슬로건으로 8주간 기획자와 디자이너가 함께 협업하는 동아리", fields: [Field.PM, Field.DESIGN, Field.UX, Field.WEB, Field.IOS, Field.ANDROID, Field.SPRING] },
    // 2026-06-01
    AUSG: { name: "AUSG", link: "https://www.instagram.com/ausg.awskrug/", dots: "🌕🌕🌗", icon: "☁️", themeColor: "slate-500", recruitStart: "6월 1일 2026", recruitEnd: "6월 30일 2026", activity: ["9월", "10월", "11월", "12월"], eligibility: [Eligibility.UNIVERSITY], description: "AWSKRUG University Student Group의 약자로, AWS를 공부하고 활용하는 대학생들의 커뮤니티", fields: [Field.CLOUD, Field.NONE] },
    // 2026-06-08
    BOAZ_H2: { name: "보아즈 (하반기)", link: "https://www.bigdataboaz.com/", dots: "🌕🌕🌕", icon: "📈", themeColor: "slate-500", recruitStart: "6월 8일 2026", recruitEnd: "6월 24일 2026", activity: ["7월", "8월", "9월", "10월", "11월", "12월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "국내 최초 빅데이터 동아리로, 6개월간 장기 프로젝트와 컨퍼런스 발표를 진행", fields: [Field.DATA_ANALYSIS, Field.DATA_VIZ, Field.DATA_ENGINEERING] },
    // 2025-06-30
    ...
    // 2025-07-17
    KUSITMS_2: { name: "큐시즘 (2학기)", link: "https://kusitms.com/", icon: "🎯", themeColor: "slate-500", dots: "🌕🌕🌗", recruitStart: "7월 17일 2025", recruitEnd: "7월 26일 2025", activity: ["9월", "10월", "11월", "12월"], eligibility: [Eligibility.UNIVERSITY], description: "기획자, 디자이너, 개발자가 함께 모여 IT 서비스를 기획하고 개발하는 대학생 연합 IT 동아리", fields: [Field.PM, Field.DESIGN, Field.WEB, Field.BACKEND] },
    // 2025-07-24
    ...
    // 2025-07-25
    CLOUD_CLUB_2: { name: "클라우드 클럽 (하반기)", link: "https://www.cloudclub.kr/", dots: "🌕🌗", icon: "☁️", themeColor: "slate-500", recruitStart: "7월 25일 2025", recruitEnd: "8월 4일 2025", activity: ["9월", "10월", "11월", "12월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "클라우드 기술에 대한 지식을 공유하고 함께 성장하는 대학생 클라우드 엔지니어링 동아리", fields: [Field.CLOUD, Field.VENDOR_NEUTRAL] },
    // 2025-08-07
    TAVE_2: { name: "TAVE (2학기)", link: "https://www.tave-wave.com/", dots: "🌕🌕", icon: "💡", themeColor: "slate-500", recruitStart: "8월 7일 2025", recruitEnd: "8월 17일 2025", activity: ["9월", "10월", "11월", "12월", "1월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "TAVE는 Technology Wave의 약자로, AI/DATA, 디자인, 개발 분야가 모여 심화 스터디 및 협업 프로젝트를 수행하며 가치를 창출하는 연합 IT동아리", fields: [Field.DESIGN, Field.ANDROID, Field.WEB, Field.BACKEND, Field.DATA_ANALYSIS, Field.DL] },
    // 2025-08-15
    ...
    // 2025-11-11
    NEXTERS_WINTER: { name: "넥스터즈 (겨울방학)", link: "https://nexters.co.kr/", dots: "🌕🌕🌕", icon: "🌊", themeColor: "slate-500", recruitStart: "11월 11일 2025", recruitEnd: "11월 20일 2025", activity: ["1월", "2월", "3월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "디자이너와 개발자가 모여 8주 동안 서비스를 만들고 런칭하는 것을 목표로 하는 동아리", fields: [Field.DESIGN, Field.ANDROID, Field.IOS, Field.WEB, Field.BACKEND] },
    // 2025-11-17
    ...
    // 2025-12-17
    TOBIGS_H1: { name: "투빅스 (상반기)", link: "http://www.datamarket.kr/xe/page_QEhq64", dots: "🌕🌕", icon: "📊", themeColor: "slate-500", recruitStart: "12월 17일 2025", recruitEnd: "12월 31일 2025", activity: ["1월", "2월", "3월", "4월", "5월", "6월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "데이터 분석 및 AI 분야에 대한 학술적 깊이를 추구하며 함께 성장하는 데이터 분석 연합 동아리", fields: [Field.ML, Field.DL] },
    // 2025-12-22
    ...
    // 2026-01-12
    CLOUD_CLUB_1: { name: "클라우드 클럽 (상반기)", link: "https://www.cloudclub.kr/", dots: "🌕🌗", icon: "☁️", themeColor: "slate-500", recruitStart: "1월 12일 2026", recruitEnd: "1월 25일 2026", activity: ["3월", "4월", "5월", "6월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "클라우드 기술에 대한 지식을 공유하고 함께 성장하는 대학생 클라우드 엔지니어링 동아리", fields: [Field.CLOUD, Field.VENDOR_NEUTRAL] },
    // 2026-01-17
    KUSITMS_1: { name: "큐시즘 (1학기)", link: "https://kusitms.com/", icon: "🎯", themeColor: "slate-500", dots: "🌕🌕🌗", recruitStart: "1월 17일 2026", recruitEnd: "1월 24일 2026", activity: ["3월", "4월", "5월", "6월"], eligibility: [Eligibility.UNIVERSITY], description: "기획자, 디자이너, 개발자가 함께 모여 IT 서비스를 기획하고 개발하는 대학생 연합 IT 동아리", fields: [Field.PM, Field.DESIGN, Field.WEB, Field.BACKEND] },
    // 2026-01-28
    ...
    // 2026-02-04
    TAVE_1: { name: "TAVE (1학기)", link: "https://www.tave-wave.com/", dots: "🌕🌕", icon: "💡", themeColor: "slate-500", recruitStart: "2월 4일 2026", recruitEnd: "2월 15일 2026", activity: ["3월", "4월", "5월", "6월", "7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], description: "TAVE는 Technology Wave의 약자로, AI/DATA, 디자인, 개발 분야가 모여 심화 스터디 및 협업 프로젝트를 수행하며 가치를 창출하는 연합 IT동아리", fields: [Field.DESIGN, Field.WEB, Field.BACKEND, Field.DATA_ANALYSIS, Field.DL] },
    // 2026-02-06
...
const Bootcamp = {
    // ── 모집 시작월 기준 정렬 ──
    KAKAO_TECH_FULLSTACK: { name: "카카오 테크 부트캠프 (풀스택)", link: "https://kakaotechbootcamp.com/", dots: "🌕🌕🌕", icon: "💛", themeColor: "slate-500", recruitStart: "2월 26일 2026", recruitEnd: "3월 22일 2026", activity: ["5월", "6월", "7월", "8월", "9월", "10월", "11월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], cost: [BootcampCost.GOV_FUNDED], description: "Java, React, SpringBoot, MySQL을 활용한 풀스택 개발자 양성 과정입니다. 교육 일정: 26.5.12 - 26.11.17", fields: [Field.WEB, Field.BACKEND] },
    ...
    SSAFY_1: { name: "SSAFY (상반기)", link: "https://www.ssafy.com/", dots: "🌕🌕🌕", icon: "💙", themeColor: "slate-500", recruitStart: "4월 27일 2026", recruitEnd: "5월 11일 2026", activity: ["7월", "8월", "9월", "10월", "11월", "12월", "1월", "2월", "3월", "4월", "5월", "6월"], eligibility: [Eligibility.UNIVERSITY], cost: [BootcampCost.FREE], description: "삼성에서 운영하는 12개월 집중 SW 교육. 수료 후 삼성 계열사 입사 기회 제공", fields: [Field.WEB, Field.BACKEND, Field.ANDROID] },
...
const Hackathon = {
    ...
    HRD_AI_CHALLENGE: { name: "HRD 미래산업인재혁신박람회 AI 아이디어 챌린지", link: "https://xn--hrd-5b7m58oe6hhrj.kr/ideachallenge", dots: "🌕", icon: "💡", themeColor: "slate-500", recruitStart: "3월 30일 2026", recruitEnd: "4월 26일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "고용노동부 주관 온라인 AI 아이디어 챌린지", fields: [Field.AI] },
    CMUX_AIM_HACKATHON: { name: "CMUX x AIM 해커톤", link: "https://luma.com/zun4wf73", dots: "🌕", icon: "🎯", themeColor: "slate-500", recruitStart: "4월 14일 2026", recruitEnd: "4월 26일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "Manaflow / AI Nexus 주관 오프라인(서울 강남) AI 해커톤", fields: [Field.AI] },
    CLAUDE_CODE_HACKATHON: { name: "Built with Opus 4.7: a Claude Code hackathon", link: "https://cerebralvalley.ai/e/built-with-4-7-hackathon", dots: "🌕", icon: "🤖", themeColor: "slate-500", recruitStart: "4월 18일 2026", recruitEnd: "4월 26일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "Cerebral Valley & Anthropic 주관 온라인 Claude Code 해커톤", fields: [Field.AI] },
    AI_EDUTHON: { name: "전국민 AI 경진대회 - AI 에듀톤", link: "https://aichallenge4all.or.kr/competitions/ai-education", dots: "🌕", icon: "🇰🇷", themeColor: "slate-500", recruitStart: "3월 28일 2026", recruitEnd: "4월 30일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "과학기술정보통신부 주관 온라인 전국민 AI 경진대회 (4월 중 마감)", fields: [Field.AI] },
    TOUR_DATA_CONTEST: { name: "2026 관광데이터 활용 공모전", link: "https://api.visitkorea.or.kr/#/cntSearchDetail?no=1", dots: "🌕", icon: "🗺️", themeColor: "slate-500", recruitStart: "3월 30일 2026", recruitEnd: "5월 6일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "한국관광공사 주관 온라인 관광데이터 활용 공모전", fields: [Field.DATA_ANALYSIS] },
    ICT_WOMEN_LEADER: { name: "2026 차세대 ICT여성리더 육성 협업 프로젝트", link: "http://www.kibwa.org/board/board_view?code=notice&no=1194", dots: "🌕", icon: "👩", themeColor: "slate-500", recruitStart: "4월 8일 2026", recruitEnd: "5월 6일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "과학기술정보통신부 주관 차세대 ICT여성리더 협업 프로젝트 지원사업", fields: [Field.DEVELOPER] },
    BUILD_WITH_AI_DAEJEON: { name: "Build with AI Hackathon 2026 in Daejeon", link: "https://ticketa.co/event/rshxbzui", dots: "🌕", icon: "🛠️", themeColor: "slate-500", recruitStart: "4월 11일 2026", recruitEnd: "5월 8일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "GDG Daejeon 주관 오프라인(대전 유성구) AI 해커톤", fields: [Field.AI] },
    NEXON_MECATHON: { name: "넥슨 패스트 트랙 해커톤 '2026 메커톤'", link: "https://maplestoryworlds.career.greetinghr.com/ko/home", dots: "🌕🌕", icon: "🎮", themeColor: "slate-500", recruitStart: "4월 24일 2026", recruitEnd: "5월 11일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE, HackathonPrize.RECRUITMENT], description: "넥슨코리아 주관 오프라인(판교) 패스트 트랙 해커톤", fields: [Field.DEVELOPER] },
    SEONGNAM_DATA_VIZ: { name: "2026 성남시 공공데이터 활용 시각화 경진대회", link: "https://www.wevity.com/?c=find&s=1&gub=1&cidx=20&gbn=viewok&gp=1&ix=105710", dots: "🌕", icon: "📈", themeColor: "slate-500", recruitStart: "4월 20일 2026", recruitEnd: "5월 13일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "성남시 주관 온라인 공공데이터 활용 시각화 경진대회", fields: [Field.DATA_VIZ] },
    PIWUDA_PROJECT: { name: "제16회 글로벌 피우다프로젝트", link: "https://ictcocpiuda.imweb.me/", dots: "🌕", icon: "🌸", themeColor: "slate-500", recruitStart: "4월 1일 2026", recruitEnd: "5월 17일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "ICT콤플렉스 피우다프로젝트 주관 한국·일본 노인돌봄 ICT솔루션 개발 대회", fields: [Field.DEVELOPER] },
    GOV_AI_INNOVATION: { name: "2026 공공기관 AI 혁신 챌린지", link: "https://aichallenge4all.or.kr/competitions/public-ai", dots: "🌕🌕", icon: "🏛️", themeColor: "slate-500", recruitStart: "5월 11일 2026", recruitEnd: "8월 31일 2026", activity: ["5월", "6월", "7월", "8월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "과기정통부·재정경제부 주최, 한국지능정보사회진흥원(NIA) 주관 온라인 공공 분야 AI 실증 경진대회", fields: [Field.AI] },
    BLOCKCHAIN_AI_HACKATHON: { name: "2026 블록체인 & AI 해커톤", link: "https://opendid.org/hackathon/2026/", dots: "🌕", icon: "⛓️", themeColor: "slate-500", recruitStart: "5월 1일 2026", recruitEnd: "5월 31일 2026", activity: ["5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "행정안전부 후원, 한국디지털인증협회 주관 오프라인 AI·블록체인 해커톤. 모바일 주민등록증 활용 서비스 개발, 총상금 3,000만원", fields: [Field.AI, Field.BACKEND] },
    CODEGATE_AI_STARTUP: { name: "2026 코드게이트 AI 스타트업 해커톤", link: "https://codegate.org", dots: "🌕", icon: "🔐", themeColor: "slate-500", recruitStart: "5월 20일 2026", recruitEnd: "7월 8일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "코드게이트 x 한컴 주관 오프라인(서울) AI 스타트업 해커톤. AI 기반 MVP 제작 무박 2일(7/21~22), 총상금 2,500만원", fields: [Field.AI] },
    HANCOM_EDU_HACKATHON: { name: "한컴 에듀 해커톤", link: "https://eduhancom.com/", dots: "🌕", icon: "📚", themeColor: "slate-500", recruitStart: "5월 20일 2026", recruitEnd: "7월 8일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "한컴 주관 오프라인 해커톤 (장소 미정)", fields: [Field.DEVELOPER] },
    NAMUHX_HACKATHON: { name: "2nd 나무엑스 Hackathon", link: "https://event-us.kr/skintellixhackathon/event/125194", dots: "🌕", icon: "🤖", themeColor: "slate-500", recruitStart: "6월 4일 2026", recruitEnd: "6월 17일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "SK인텔릭스 주관 오프라인(워커힐 호텔) AI 해커톤. 나무엑스 AI 로봇 활용 시나리오 제안, 총상금 500만원", fields: [Field.AI] },
    DACON_WEB_MINIGAME: { name: "DACON 웹 미니게임 해커톤", link: "https://daker.ai/public/hackathons/monthly-hackathon-web-minigame-challenge", dots: "🌕", icon: "🎮", themeColor: "slate-500", recruitStart: "5월 4일 2026", recruitEnd: "5월 26일 2026", activity: ["5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "DACON 주관 온라인 웹 미니게임 해커톤", fields: [Field.WEB] },
    NL_DATA_CONTEST: { name: "2026 도서관 데이터 활용 공모전", link: "https://nl.go.kr/NL/contents/N50601000000.do?schM=view&page=1&viewCount=10&id=57417&schBdcode=&schGroupCode=", dots: "🌕", icon: "📚", themeColor: "slate-500", recruitStart: "6월 1일 2026", recruitEnd: "8월 7일 2026", activity: ["6월", "7월", "8월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE, HackathonPrize.CERTIFICATE], description: "국립중앙도서관 주관 도서관 데이터 활용 공모전. 시상규모 100만원, 상장 수여. 지원 이메일: libdata@korea.kr", fields: [Field.DATA_ANALYSIS] },
    JST_DODREAM: { name: "2026 JST공유대학 두드림 챌린지", link: "https://ainnov.co.kr/jst", dots: "🌕", icon: "🎓", themeColor: "slate-500", recruitStart: "7월 1일 2026", recruitEnd: "7월 11일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE], description: "JST공유대학 두드림(Do-Dream) 챌린지 해커톤 경진대회. 시상규모 360만원", fields: [Field.DEVELOPER] },
    MIRAE_ASSET_AI: { name: "미래에셋증권 제10회 AI페스티벌", link: "https://miraeassetfesta.com/", dots: "🌕🌕🌕", icon: "💰", themeColor: "slate-500", recruitStart: "7월 6일 2026", recruitEnd: "7월 20일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE], description: "미래에셋증권 주관 AI 페스티벌. 총 시상규모 5,500만원", fields: [Field.AI] },
    MOVE_AI_CHALLENGE: { name: "MOVE AI CHALLENGE 2026", link: "https://www.thinkcontest.com/thinkgood/user/contest/view.do?querystr=gpgXCwaRVhgtV7RtsEujJfCURd10WnjoSHBgFk95E7Y", dots: "🌕🌕", icon: "🚚", themeColor: "slate-500", recruitStart: "6월 22일 2026", recruitEnd: "7월 10일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "국토교통부 주최, 물류산업진흥재단 주관 물류AI 아이디어 구현 해커톤. 후원: 한국철도공사, 카카오모빌리티, 현대글로비스. 총상금 800만원", fields: [Field.AI, Field.DEVELOPER] },
    YOGIYO_HACKATHON: { name: "요기요 해커톤", link: "https://wesangcareer.ninehire.site/yogiyo_hackathon", dots: "🌕🌕", icon: "🍽️", themeColor: "slate-500", recruitStart: "6월 22일 2026", recruitEnd: "7월 12일 2026", activity: ["7월", "8월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE, HackathonPrize.RECRUITMENT], description: "요기요 주관 해커톤. 최우수상 200만원, 우수상 100만원, 장려상 50만원. 최우수팀 인턴 2개월 기회, 수상팀 서류/과제 전형 면제", fields: [Field.DEVELOPER] },
    BDAI_SUPERBAI_HACKATHON: { name: "제1회 B.D.A.I × Superb AI 해커톤", link: "https://bdai-superbai-hackathon-landingpage.figma.site", dots: "🌕", icon: "🧠", themeColor: "slate-500", recruitStart: "7월 4일 2026", recruitEnd: "7월 7일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE, HackathonPrize.RECRUITMENT], description: "B.D.A.I × Superb AI 주관 실무형 AI 해커톤. 총상금 100만원, 1등 팀 인턴십 우대, 현직자 멘토링", fields: [Field.AI] },
};
