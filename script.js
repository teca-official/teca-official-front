...
const Hackathon = {
    ...
    HRD_AI_CHALLENGE: { name: "HRD 미래산업인재혁신박람회 AI 아이디어 챌린지", link: "", dots: "🌕", icon: "💡", themeColor: "slate-500", recruitStart: "3월 30일 2026", recruitEnd: "4월 26일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "고용노동부 주관 온라인 AI 아이디어 챌린지", fields: [Field.AI] },
    CMUX_AIM_HACKATHON: { name: "CMUX x AIM 해커톤", link: "", dots: "🌕", icon: "🎯", themeColor: "slate-500", recruitStart: "4월 14일 2026", recruitEnd: "4월 26일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "Manaflow / AI Nexus 주관 오프라인(서울 강남) AI 해커톤", fields: [Field.AI] },
    CLAUDE_CODE_HACKATHON: { name: "Built with Opus 4.7: a Claude Code hackathon", link: "", dots: "🌕", icon: "🤖", themeColor: "slate-500", recruitStart: "4월 18일 2026", recruitEnd: "4월 26일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "Cerebral Valley & Anthropic 주관 온라인 Claude Code 해커톤", fields: [Field.AI] },
    AI_EDUTHON: { name: "전국민 AI 경진대회 - AI 에듀톤", link: "", dots: "🌕", icon: "🇰🇷", themeColor: "slate-500", recruitStart: "3월 28일 2026", recruitEnd: "4월 30일 2026", activity: ["4월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "과학기술정보통신부 주관 온라인 전국민 AI 경진대회 (4월 중 마감)", fields: [Field.AI] },
    TOUR_DATA_CONTEST: { name: "2026 관광데이터 활용 공모전", link: "", dots: "🌕", icon: "🗺️", themeColor: "slate-500", recruitStart: "3월 30일 2026", recruitEnd: "5월 6일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "한국관광공사 주관 온라인 관광데이터 활용 공모전", fields: [Field.DATA_ANALYSIS] },
    ICT_WOMEN_LEADER: { name: "2026 차세대 ICT여성리더 육성 협업 프로젝트", link: "", dots: "🌕", icon: "👩", themeColor: "slate-500", recruitStart: "4월 8일 2026", recruitEnd: "5월 6일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "과학기술정보통신부 주관 차세대 ICT여성리더 협업 프로젝트 지원사업", fields: [Field.DEVELOPER] },
    BUILD_WITH_AI_DAEJEON: { name: "Build with AI Hackathon 2026 in Daejeon", link: "", dots: "🌕", icon: "🛠️", themeColor: "slate-500", recruitStart: "4월 11일 2026", recruitEnd: "5월 8일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "GDG Daejeon 주관 오프라인(대전 유성구) AI 해커톤", fields: [Field.AI] },
    NEXON_MECATHON: { name: "넥슨 패스트 트랙 해커톤 '2026 메커톤'", link: "", dots: "🌕🌕", icon: "🎮", themeColor: "slate-500", recruitStart: "4월 24일 2026", recruitEnd: "5월 11일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY], prize: [HackathonPrize.PRIZE, HackathonPrize.RECRUITMENT], description: "넥슨코리아 주관 오프라인(판교) 패스트 트랙 해커톤", fields: [Field.DEVELOPER] },
    SEONGNAM_DATA_VIZ: { name: "2026 성남시 공공데이터 활용 시각화 경진대회", link: "", dots: "🌕", icon: "📈", themeColor: "slate-500", recruitStart: "4월 20일 2026", recruitEnd: "5월 13일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "성남시 주관 온라인 공공데이터 활용 시각화 경진대회", fields: [Field.DATA_VIZ] },
    PIWUDA_PROJECT: { name: "제16회 글로벌 피우다프로젝트", link: "", dots: "🌕", icon: "🌸", themeColor: "slate-500", recruitStart: "4월 1일 2026", recruitEnd: "5월 17일 2026", activity: ["4월", "5월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "ICT콤플렉스 피우다프로젝트 주관 한국·일본 노인돌봄 ICT솔루션 개발 대회", fields: [Field.DEVELOPER] },
    GOV_AI_INNOVATION: { name: "2026 공공기관 AI 혁신 챌린지", link: "", dots: "🌕🌕", icon: "🏛️", themeColor: "slate-500", recruitStart: "5월 11일 2026", recruitEnd: "8월 31일 2026", activity: ["5월", "6월", "7월", "8월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "과학기술정보통신부 주관 온라인 공공기관 AI 혁신 챌린지", fields: [Field.AI] },
};
