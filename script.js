...
const Hackathon = {
    ...
    CODEGATE_AI_STARTUP: { name: "2026 코드게이트 AI 스타트업 해커톤", link: "https://codegate.org", dots: "🌕", icon: "🔐", themeColor: "slate-500", recruitStart: "5월 1일 2026", recruitEnd: "7월 8일 2026", activity: ["7월"], eligibility: [Eligibility.UNIVERSITY, Eligibility.WORKER], prize: [HackathonPrize.PRIZE], description: "코드게이트 x 한컴 주관 오프라인(서울) AI 스타트업 해커톤. AI 기반 MVP 제작 무박 2일(7/21~22), 총상금 1,500만원", fields: [Field.AI] },
